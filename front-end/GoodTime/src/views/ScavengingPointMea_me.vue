    ...
    <div style="width:100%;height: 100%;">
        ...
        <div class="goods">
            <div class="menu-wrapper" style="position: relative;">
            	<div class="wrapper" style="position:absolute;left:0;top:0;height:100%;width:100%;margin-top:0;"  ref="menuWrapper">
            		<ul :style="menuHeight">
            ...
            <div class="goods-wrapper" style="position:relative;">
                <div class="goods-wrapper-title" v-if="groupList.length > 0">{{groupList[menuCurIndex].cat_name_cn}}</div>
                <div style="position:absolute;top:.68rem;bottom:0;left:0;width:100%;">
                	<div class="wrapper" style="position:absolute;left:0;top:0;height:100%;width:100%;margin-top:0;"  ref="goodsWrapper">
	                	<ul :style="goodsHeight">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            menuHeight() {
            	let height = `height: ${0.8 * this.groupList.length}rem`;
            	return height
            },
            goodsHeight() {
            	let height = `height: ${2 * (this.goodsList.length + 1)}rem`;
            	return height
            }
        },
        created() {
        ...
        methods: {
            ...
            menuClick(index, id, event) {
                ...
                obj.id = id;
                obj.sid = this.sid;
                this.getGoodsList(obj).then(() => {
                    if(!this.goodsScroll) {
                        this.$nextTick(() => {
                            this.goodsScroll = new BScroll(this.$refs.goodsWrapper, {click: true, scrollX: false, scrollY: true});
                        })
                    } else {
