	...
	<div><!-- 固定 容器-->
		...
		<div class="video-details-content-box">
			...
			<div class="video-details-content">
				...
				<div class="video-details-content-right">
					...
					<p class="video-details-content-right-title-en">{{MovieD.film_brief}}</p>
		...
		<div class="video-synopsis">
			...
			<div class="video-synopsis-bottom">
				...
				<div class="video-synopsis-actor-img" style="position:relative;">
					<div class="wrapper" style="position:absolute;left:0;top:0;height:100%;" ref="gActorWrapper">
		...
		<div class="stage-photo-box">
			<div class="stage-photo">
				...
				<div class="stage-photo-list" style="position:relative;">
					<div class="wrapper" style="position:absolute;left:0;top:0;height:100%;" ref="gStageScroll">
	...
	export default {
		data : function(){
			...
			MovieDeatil:function(){
				var page = this;
		        var url = '/general_api/api/MovieFutureDetails?movie_id='+page.mid+'&ts='+Date.parse(new Date());
		        fetch(url).then(r => r.json()).then(d => {
		        	if (d.code == 0) {
		        		...
		        		page.$nextTick(() => {
							page.gActorScroll = new BScroll(page.$refs.gActorWrapper, {click: true,eventPassthrough: true, scrollX: true, scrollY: false, preventDefault: false});
							page.gStageScroll = new BScroll(page.$refs.gStageScroll, {click: true, eventPassthrough: true, scrollX: true, scrollY: false, preventDefault: false})
						});
